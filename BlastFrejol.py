...
proteinas_fasta = "ProteinasPhaseolus_limpio.fasta"
genes_fasta = "GenesPhaseolus_cleaned.fasta"

# Directorios de salida
output_dir_proteinas = "./Proteinas_Seleccionadas"
output_dir_genes = "./Genes_Ortologos_Resultados"
...
for archivo in os.listdir("."):
    if archivo.endswith("_gene.fasta"):
        ...
        comando_blastx = f"blastx -query {archivo} -db ProteinasPhaseolusDB -outfmt '6 sseqid pident length evalue' -max_target_seqs 1 -out {blastx_out}"
        ...
        try:
            ...
            comando_tblastn = f"tblastn -query {secuencia_proteina_path} -db GenesPhaseolusDB -outfmt '6 sseqid pident length evalue' -max_target_seqs 1 -out {tblastn_out}"
            ...
            gen_homologo_path = f"{output_dir_genes}/Ortólogoa{nombre_gene}_{id_gene}.fasta"
