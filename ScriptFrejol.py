...
def obtener_secuencias():
    ...
    coordenadas_file_path = f"Coordenadas{ids_concatenados}.txt"
    ...
    try:
        ...
        subprocess.run(["python3", "BlastFrejol.py"], check=True)
        messagebox.showinfo("Proceso Completo", "Soya_Phaseolus.py se ha ejecutado exitosamente.")

    except subprocess.CalledProcessError:
        messagebox.showerror("Error", "Hubo un error al ejecutar descargar_secuencias1.sh o Soya_Phaseolus.py.")
